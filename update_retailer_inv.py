                ...
                <tr>
                    ...
                    <td style="width: 50%;" class="invoice-title-wrapper">
                        ...
                        <div class="invoice-meta">
                            ...
                            Payment Status: <span class="status-badge {{ strtolower($retailerOrder->payment_status) == 'paid' ? 'status-paid' : 'status-pending' }}">{{ ucfirst($retailerOrder->payment_status) }}</span>
                        </div>
                    </td>
                </tr>
            </table>
                    ...
                    <td style="padding-left: 15px;">
                        <div class="info-block">
                            ...
                            <div class="info-content">
                                ...
                                {{ $retailerOrder->retailer->address ?? ($retailerOrder->retailer->shop_address ?? '') }} {{ $retailerOrder->retailer->pincode ?? '' }}<br>
                                Phone: {{ $retailerOrder->retailer->contact_no ?? ($retailerOrder->retailer->phone ?? 'N/A') }}<br>
                                {!! $retailerOrder->retailer->user->email ? 'Email: ' . $retailerOrder->retailer->user->email . '<br>' : '' !!}
                                @if(!empty($retailerOrder->retailer->gst)) GST: {{ $retailerOrder->retailer->gst }}<br> @endif
                                @if(!empty($retailerOrder->retailer->drug_license_no)) DL No: {{ $retailerOrder->retailer->drug_license_no }} @endif
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td style="width: 50%;">
                        @if(isset($retailerOrder->loyalty_points_earned) && $retailerOrder->loyalty_points_earned > 0)
                            <div class="loyalty-points">
                                ...
                                {{ number_format($retailerOrder->loyalty_points_earned) }} Loyalty Points Earned on this invoice!
                            </div>
                        @endif
                    </td>
                    <td style="width: 50%;">
...
with codecs.open(r'c:\wamp64\www\prs\resources\views\admin\orders\retailers\invoice.blade.php', 'w', 'utf-8') as f:
    f.write(retailer_content)

print("Retailer invoice updated successfully.")
