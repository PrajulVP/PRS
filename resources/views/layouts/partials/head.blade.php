...
<link rel="icon" href="{{ asset('admin/assets/images/logo/atom-logo.webp') }}" type="image/x-icon">
<link rel="shortcut icon" href="{{ asset('admin/assets/images/logo/atom-logo.webp') }}" type="image/x-icon">
<title>P R S</title>
<!-- Google font-->
