                            ...
                            <div class="card-body p-4" style="border-radius: 0 0 16px 16px;">
                                <div class="row g-3">
                                    @php
                                        ...
                                        $targetRetailer = $selectedRetailer ?? ($retailer ?? null);
                                        if ($targetRetailer) {
                                    ...
                                    <!-- Overall Target & Achievement Summary Header -->
                                    <div class="col-12 mb-3">
                                        <div class="p-3 rounded-4 border shadow-2xs bg-light-soft" style="border-color: var(--med-border, #e2e8f0) !important;">
