            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('distributor-orders.update', $distributorOrder->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select" id="status" required>
                                @foreach(['pending', 'accepted', 'dispatched', 'delivered', 'cancelled'] as $statusOption)
                                    <option value="{{ $statusOption }}" {{ (old('status', $distributorOrder->status) == $statusOption) ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            <label>Notes</label>
                            <textarea name="notes" class="form-control">{{ old('notes', $distributorOrder->notes) }}</textarea>
                        </div>
