    ...
    <div class="invoice-box">
        ...
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="4">
                    <table>
                        <tr>
                            ...
                            <td>
                                Invoice #: {{ $distributorOrder->order_code }}<br>
                                Created: {{ $distributorOrder->created_at->format('F d, Y') }}<br>
                                Status: {{ ucfirst(str_replace('_', ' ', $distributorOrder->status)) }}<br>
                                Payment: {{ ucfirst($distributorOrder->payment_status) }}
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                {{ $distributorOrder->distributor->user->name ?? 'Distributor Name' }}<br>
                                {{ $distributorOrder->distributor->user->email ?? 'email@example.com' }}<br>
                                {{ $distributorOrder->distributor->phone ?? '' }}<br>
            ...
            <tr class="total">
                ...
                <td style="text-align: right;">
                    <strong>{{ number_format($distributorOrder->total_amount, 2) }}</strong>
                </td>
            </tr>
        </table>
