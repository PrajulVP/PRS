                        ...
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="card h-100 border-0 shadow-sm" style="border-radius: 16px !important;">
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-bold mb-1" style="color: var(--med-text-main);">${row.name || 'N/A'}</h5>
                                    ...
                                    <div class="d-flex align-items-start mb-1 text-wrap"><i class="fa fa-map-marker text-muted me-2 mt-1" style="width: 16px;"></i> <span class="small" style="max-width: 200px;">${row.distributor_address || 'N/A'}</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 shadow-sm" style="border-radius: 16px !important;">
                                <div class="card-body">
                                    ...
                                    <h5 class="fw-bold mb-2" style="color: var(--med-text-main);">PRS Company</h5>
