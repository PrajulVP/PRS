        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" class="p-3 border rounded">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="pack_quantity" id="pack_quantity" class="form-control" 
                                        value="{{ old('pack_quantity', $product->pack_quantity) }}" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="expiry" id="expiry" class="form-control" 
                                        value="{{ old('expiry', $product->expiry->format('Y-m-d')) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="strip_size" class="form-label">Strip Size</label>
                                    <input type="number" name="strip_size" id="strip_size" class="form-control" 
                                        value="{{ old('strip_size', $product->strip_size) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="box_size" class="form-label">Box Size</label>
                                    <input type="number" name="box_size" id="box_size" class="form-control" 
                                        value="{{ old('box_size', $product->box_size) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="carton_size" class="form-label">Carton Size</label>
                                    <input type="number" name="carton_size" id="carton_size" class="form-control" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="batch_no" id="batch_no" class="form-control" 
                                        value="{{ old('batch_no', $product->batch_no) }}" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="ptr" id="ptr" class="form-control" 
                                        value="{{ old('ptr', $product->ptr) }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="taxable_value" class="form-label">Taxable Value</label>
                                    <input type="number" step="0.01" name="taxable_value" id="taxable_value" class="form-control" 
                                        value="{{ old('taxable_value', $product->taxable_value) }}" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="offer" id="offer" class="form-control" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" name="net_amount" id="net_amount" class="form-control" 
                                        value="{{ old('net_amount', $product->net_amount) }}" required>
                                </div>
                            </div>
                        </div>
