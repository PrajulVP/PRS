...
<div class="modal fade" id="showRetailerModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3" id="showRetailerDetails">
                    <!-- Dynamic Details -->
                </div>
                <hr class="my-4">
...
<script>
    $(document).ready(function() {
        ...
        $('#retailers-table').on('click', '.view-btn', function() {
            ...
            let html = `
                <div class="col-md-6"><label class="fw-bold text-muted small text-uppercase">Shop Name</label><p class="fw-bold mb-0">${data.shop_name}</p></div>
                <div class="col-md-6"><label class="fw-bold text-muted small text-uppercase">Owner Name</label><p class="mb-0">${data.user.name}</p></div>
                ...
                <div class="col-md-6"><label class="fw-bold text-muted small text-uppercase">GST</label><p class="mb-0">${data.gst || 'N/A'}</p></div>
