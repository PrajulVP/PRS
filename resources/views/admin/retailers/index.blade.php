                ...
                <div class="modal-body p-0">
                    ...
                    <div class="p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12" id="ret_view_map_container">
                                <label class="form-label text-muted small fw-bold"><i class="fa fa-map-marked-alt me-1 text-primary"></i>Location (Map)</label>
                                <div id="show_map" style="height: 250px; width: 100%; border: 1px solid #e2e8f0; border-radius: 8px;"></div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (id, type, row) {
                            ...
                            let resetUrl = "{{ route('admin.retailers.reset-location', ':id') }}".replace(':id', id);
                            ...
                            if (hasLocation) {
                                btns += `<button type="button" class="btn btn-sm btn-warning text-white reset-location-btn" data-url="${resetUrl}" data-name="${row.shop_name}" title="Reset Saved Location"><span style="position: relative; display: inline-flex; align-items: center; justify-content: center; line-height: 1; overflow: visible;"><i class="fa fa-map-marker" style="font-size: 1.5rem; color: #ffffff;"></i><span style="position: absolute; top: 50%; left: 50%; width: 210%; height: 2px; background-color: #ffffff; transform: translate(-50%, -50%) rotate(-45deg); transform-origin: center; box-shadow: 0 0 1px rgba(0,0,0,0.5);"></span></span></button>`;
                            } else {
                                btns += `<button type="button" class="btn btn-sm btn-warning text-white no-location-btn" data-name="${row.shop_name}" title="No location set for this retailer" style="opacity: 0.55; cursor: not-allowed;"><span style="position: relative; display: inline-flex; align-items: center; justify-content: center; line-height: 1; overflow: visible;"><i class="fa fa-map-marker" style="font-size: 1.5rem; color: #ffffff;"></i><span style="position: absolute; top: 50%; left: 50%; width: 210%; height: 2px; background-color: #ffffff; transform: translate(-50%, -50%) rotate(-45deg); transform-origin: center; box-shadow: 0 0 1px rgba(0,0,0,0.5);"></span></span></button>`;
                            }
            ...
            $(document).on('click', '.no-location-btn', function () {
                let name = $(this).data('name') || 'this retailer';
