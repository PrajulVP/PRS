                                    ...
                                    <div class="card border-0 shadow-sm h-100" style="border-radius: 15px; border-left: 4px solid var(--med-primary) !important; background: #fff;">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex justify-content-between text-muted mb-1 fw-600" style="font-size: 12px;">
                                                <span>Current: Γé╣{{ number_format($reward['current_total'], 2) }}</span>
                                                @if($reward['next_target'])
                                                    <span>Target: Γé╣{{ number_format($reward['next_target'], 2) }}</span>
                                                @endif
                                            </div>
                                            ...
                                            @if($reward['next_target'])
                                                ...
                                                <div class="mt-2 text-end text-muted fw-bold" style="font-size: 11px;">
                                                    Γé╣{{ number_format($reward['next_target'] - $reward['current_total'], 2) }} more for next reward!
                                                </div>
                                            @else
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-0 shadow-sm premium-stats-card h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h4 class="fw-800 mb-0">Γé╣{{ number_format($achieved, 0) }}</h4>
                                    <p class="text-muted small mb-0 mt-1">Goal: Γé╣{{ number_format($target, 0) }}</p>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-0 shadow-sm premium-stats-card h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h4 class="fw-800 mb-0 text-danger">Γé╣{{ number_format($data_extra['outstanding'] ?? 0, 0) }}</h4>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-0 shadow-sm premium-stats-card h-100">
                                <div class="card-body p-4">
                                    ...
                                    <h4 class="fw-800 mb-0" style="color: #0ea5e9;">Γé╣{{ number_format(Auth::user()->distributor->credit_balance ?? 0, 2) }}</h4>
                                                ...
                                                @forelse($topRetailers as $tr)
                                                    <tr>
                                                        ...
                                                        <td class="text-end px-4">
                                                            <span class="text-success fw-800">Γé╣{{ number_format($tr->total_revenue, 0) }}</span>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    ...
                                                    <tr style="border-bottom: 1px solid #f8f9fc;">
                                                        ...
                                                        <td class="text-right px-4 py-3 align-middle">
                                                            <h6 class="mb-0 font-weight-bold text-success" style="font-size: 0.95rem;">
                                                                Γé╣{{ number_format($tp->total_revenue, 0) }}</h6>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                ...
                                <div class="card p-4 border-0 shadow-sm h-100" style="border-radius: 20px;">
                                    ...
                                    <div class="row text-center mb-4">
                                        <div class="col-md-3">
                                            ...
                                            <h4 class="fw-800 text-dark">Γé╣{{ number_format($data_extra['global_target'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Total Achieved</div>
                                            <h4 class="fw-800 text-success">Γé╣{{ number_format($data_extra['global_achieved'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Remaining</div>
                                            <h4 class="fw-800 text-warning">Γé╣{{ number_format($data_extra['global_remaining'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-3 py-2 text-end text-dark fw-bold small">Γé╣{{ number_format($sm['target']) }}</td>
                                                    <td class="px-3 py-2 text-end text-success fw-bold small">Γé╣{{ number_format($sm['achieved']) }}</td>
                                                    <td class="px-3 py-2 text-end text-warning fw-bold small">Γé╣{{ number_format($sm['remaining']) }}</td>
                            ...
                            <div class="col-lg-12 mb-4">
                                <div class="card p-4 border-0 shadow-sm h-100" style="border-radius: 20px;">
                                    ...
                                    <div class="row text-center mb-4">
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Total Target</div>
                                            <h4 class="fw-800 text-dark">Γé╣{{ number_format($data_extra['target'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Achieved</div>
                                            <h4 class="fw-800 text-success">Γé╣{{ number_format($data_extra['achieved'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Remaining</div>
                                            <h4 class="fw-800 text-warning">Γé╣{{ number_format($data_extra['remaining'] ?? 0) }}</h4>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="text-muted small fw-bold text-uppercase">Completion</div>
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-3 py-2 text-end text-dark fw-bold small">Γé╣{{ number_format($fs['target']) }}</td>
                                                    <td class="px-3 py-2 text-end text-success fw-bold small">Γé╣{{ number_format($fs['achieved']) }}</td>
                                                    <td class="px-3 py-2 text-end text-warning fw-bold small">Γé╣{{ number_format($fs['remaining']) }}</td>
                                                    <td class="px-3 py-2 text-end" style="width: 20%;">
                                                        <div class="progress mb-1" style="height: 6px; border-radius: 3px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2 text-end">
                                                        <div class="fw-800 text-primary small">Γé╣{{ number_format($area->total_revenue, 0) }}</div>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                                        ...
                                                        <tbody>
                                                            @forelse($topDistributors as $td)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        <span class="text-success fw-800" style="font-size: 13px;">Γé╣{{ number_format($td->total_revenue, 0) }}</span>
                                                                    </td>
                                                                </tr>
                                                            @empty
                                                        ...
                                                        <tbody>
                                                            @forelse($topRetailers as $tr)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        <span class="text-success fw-800" style="font-size: 13px;">Γé╣{{ number_format($tr->total_revenue, 0) }}</span>
                                                                    </td>
                                                                </tr>
                                                            @empty
                                                                <tr><td colspan="2" class="text-center text-muted py-3">No data</td></tr>
                                        ...
                                        <tbody>
                                            @forelse($recentRetailerOrders as $order)
                                                <tr>
                                                    ...
                                                    <td class="fw-800 text-dark" style="font-size: 13px;">Γé╣{{ number_format($order->total_amount, 0) }}</td>
                                                    <td class="text-end px-4">
                                        ...
                                        tooltip: { 
                                            ...
                                            y: {
                                                formatter: function (val) {
                                                    return isCurrency ? 'Γé╣' + Number(val).toLocaleString() : val;
                                                }
                                            }
                                        },
                                ...
                                if (document.querySelector("#brandDistributionChart")) {
                                    ...
                                    var brandOptions = {
                                                    ...
                                                    labels: {
                                                        ...
                                                        total: {
                                                            ...
                                                            formatter: function (w) {
                                                                if (!hasBrandData || isBrandZero) return 'Γé╣0';
                                                                return 'Γé╣' + w.globals.seriesTotals.reduce((a, b) => a + b, 0).toLocaleString(undefined, {maximumFractionDigits: 0});
                                                            }
                                                        },
                                                        value: {
                                                            show: true,
                                        ...
                                        tooltip: { 
                                            ...
                                            theme: tooltipTheme,
                                            y: {
                                                formatter: (val) => 'Γé╣' + val.toLocaleString()
                                            }
                                        },
                                        responsive: [{
                                            breakpoint: 1366,
                                                            ...
                                                            <div class="row g-2 mt-1">
                                                                <div class="col-6">
                                                                    <div class="p-2 rounded h-100" style="background: rgba(120, 120, 120, 0.08);">
                                                                        ...
                                                                        <p class="fw-800 mb-0 text-success" style="font-size: 0.9rem;">Γé╣${r.total_revenue}</p>
                                                                    </div>
                                                                </div>
