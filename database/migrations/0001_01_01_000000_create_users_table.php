...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            // $table->string('contact_no', 20)->unique()->nullable(); // Removed
            // $table->string('address', 255)->nullable(); // Removed
            // $table->string('pincode')->nullable(); // Removed
            // $table->foreignId('district_id')->nullable()->constrained()->onDelete('cascade'); // Removed
            // $table->foreignId('area_id')->nullable()->constrained()->onDelete('cascade'); // Removed
